// Welcome to the main SEB$TA script
        ...
        .then(() => {
          ...
          if (option === "on") {
            ...
            setTimeout(() => {
              ...
              // The blob writing is just the background elements, like the "SEB is loading your content, please wait" screen. It does not carry proxied content, or even the iframe.
              blob.write(`
           <script> 
           function handleTabLeave(activeInfo) {
  var link = document.querySelector("link[rel~='icon']");
  if (localStorage.getItem('ADVcloak') == "on") {
  if (document.title == "SEB$TA") {
    if (!link) {
...
document.addEventListener("visibilitychange", handleTabLeave)
           ...
           <div class="loader">
  <div>SEB$TA is loading your content!</div>
  <div style='font-size:35px;'>Please wait while I cook this up bro</div>
  <div class="b1"></div> 
  <div class="b2"></div>
  <div class="b3"></div>
</div> 
...
function log() {
  ...
  setTimeout(
    console.log.bind(
      console,
      "%c If you are seeing this, SEB$TA's main script has succesfully loaded!",
